...
const TopChartCard = ({song,i,isPlaying,handlePauseClick,handlePlayClick,activeSong})=>{
  return(<div className="w-full flex flex-row items-center hover:bg-[#a190d6] py-2 p-4 rounded-lg cursor-pointer mb-2 ">
...
const TopPlay = () =>{
  ...
  // this is for the scroll to the top when app is reloaded
  useEffect(()=>{
    ...
    <>
      <div className='xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[400px] max-w-full flex flex-col ' ref={divRef} >
        ...
        <div className="flex flex-row justify-between items-center">
          ...
          {/* song details page after remove it */}
                {/* <SongDetails /> */}
      </div>
